...
export class InlineResponse404 extends ExtendedErrorModel {
   ...
   * @param {module:InlineResponse404} obj Optional instance to populate.
   * @return {module:InlineResponse404} The populated <code>InlineResponse404</code> instance.
   */
