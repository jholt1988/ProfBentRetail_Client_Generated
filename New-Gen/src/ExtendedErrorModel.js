...
export class ExtendedErrorModel extends ErrorModel {
   ...
   * @param {module:ExtendedErrorModel} obj Optional instance to populate.
   * @return {module:ExtendedErrorModel} The populated <code>ExtendedErrorModel</code> instance.
   */
