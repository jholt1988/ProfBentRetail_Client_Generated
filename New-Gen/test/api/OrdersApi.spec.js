...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new profbent.OrdersApi();
  });
  ...
  describe('OrdersApi', function() {
    describe('getAllUserOrders', function() {
      it('should call getAllUserOrders successfully', function(done) {
        //uncomment below and update the code to test getAllUserOrders
        //instance.getAllUserOrders(function(error) {
    ...
    describe('postNewOrder', function() {
      it('should call postNewOrder successfully', function(done) {
        //uncomment below and update the code to test postNewOrder
        //instance.postNewOrder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
