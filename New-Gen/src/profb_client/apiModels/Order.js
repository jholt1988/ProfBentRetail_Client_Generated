...
* @module profb_client/apiModels/Order
* @version 1.67
*/
export default class Order {
    ...
    * @alias module:profb_client/apiModels/Order
    * @class
    */
    ...
    * @param {module:profb_client/apiModels/Order} obj Optional instance to populate.
    * @return {module:profb_client/apiModels/Order} The populated <code>Order</code> instance.
    */
    ...
    */
    'payId' = undefined;
    /**
    * @member {Array.<module:profb_client/apiModels/OrderItems>} items
    */
    'items' = undefined;
    /**
