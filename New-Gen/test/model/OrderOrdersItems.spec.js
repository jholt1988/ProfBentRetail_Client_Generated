...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderOrdersItems', function() {
      beforeEach(function() {
        instance = new ProfBentleyEcommerceApi.OrderOrdersItems();
      });

      it('should create an instance of OrderOrdersItems', function() {
        // TODO: update the code to test OrderOrdersItems
        expect(instance).to.be.a(ProfBentleyEcommerceApi.OrderOrdersItems);
      });
