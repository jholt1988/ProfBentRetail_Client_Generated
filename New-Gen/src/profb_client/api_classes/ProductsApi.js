...
/**
* Products service.
* @module profb_client/api_classes/ProductsApi
* @version 1.67
*/
export default class ProductsApi {
    ...
    * @alias module:profb_client/api_classes/ProductsApi
    * @class
    ...
    */
     ...
     * @callback module:profb_client/api_classes/ProductsApi~getAllproductsCallback
     ...
     * @param {module:profb_client/api_classes/ProductsApi~getAllproductsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:profb_client/api_classes/ProductsApi~getProductCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:profb_client/api_classes/ProductsApi~getProductCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:profb_client/api_classes/ProductsApi~updateProductCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:profb_client/api_classes/ProductsApi~updateProductCallback} callback The callback function, accepting three arguments: error, data, response
