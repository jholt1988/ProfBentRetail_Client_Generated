...
* @module profb_client/apiModels/Type
* @version 1.67
*/
export default class Type {
    ...
    * @alias module:profb_client/apiModels/Type
    * @class
    */
    ...
    * @param {module:profb_client/apiModels/Type} obj Optional instance to populate.
    * @return {module:profb_client/apiModels/Type} The populated <code>Type</code> instance.
    */
